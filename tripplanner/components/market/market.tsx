...
const MarketCardsComponent: React.FC<MarketCardsComponentProps> = ({
  ...
  return (
    <div className="space-y-4 font-sans overflow-y-auto max-h-[90vh] lg:max-h-[calc(100vh-140px)] p-4"> 
            ...
            <div>
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <h3 className="text-lg font-semibold text-blue-500 mr-2 truncate max-w-[180px] lg:max-w-[240px]">
                    {plan.name}
                  </h3>
                  <div className="flex items-center">
              ...
              <div className="flex items-center mt-4">
                ...
                <p className="text-sm text-gray-500">
                  Duration: <span>{plan.totalDays} days</span>
                </p>
              </div>
            </div>

            {/* Budget and Price Information */}
            <div className="flex lg:flex-row flex-col justify-between items-start lg:items-end mt-4">
              <div className="flex items-center">
                <FaDollarSign className="text-gray-500 mr-2" />
                <p className="text-sm font-semibold text-gray-600 truncate">
                  Budget: <span className="text-lg">TND {plan.totalPrice}</span>
                </p>
              </div>
              ...
              <div className="flex items-center mt-2 lg:mt-0">
                ...
                <p className="text-sm font-semibold text-green-600 truncate">
                  Price: <span className="text-lg">TND {plan.totalCost}</span>
                </p>
              </div>

              <button className="mt-2 lg:mt-0 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-200">
                View Details
              </button>
            </div>
          </div>
