...
const HomePage = () => {
  ...
  return (
    <div className="w-full h-screen bg-gray-200 flex flex-col items-center font-amifer overflow-x-hidden">
      {/* Full-width Blue Background Section */}
      <div className="w-full relative py-10 lg:py-36 flex flex-col items-center justify-start shadow-lg">
  {/* Background Image */}
  <img src={bgImage.src} alt="Background" className="absolute inset-0 w-full h-full object-cover z-0" />
  
  {/* Left side shadow gradient */}
  <div className="absolute left-0 top-0 bottom-0 w-64 bg-gradient-to-r from-black/50 to-transparent z-10"></div>
  
  {/* Right side shadow gradient */}
  <div className="absolute right-0 top-0 bottom-0  w-64 bg-gradient-to-l from-black/50 to-transparent z-10"></div>
  
  {/* Content */}
  <div className="relative z-20 w-full flex flex-col items-center">
    <h1 className="text-xl lg:text-4xl font-bold mt-8 lg:mt-4 mb-4 text-white max-w-screen-2xl w-full text-left px-4 lg:px-12">
      Plan your trip with ease
    </h1>
    <h2 className="text-xl lg:text-4xl font-semibold pt-4 lg:pt-8 mt-2 lg:mt-4 text-white text-center">
      Where are we headed?
    </h2>
  </div>
</div>
      ...
      <div className="w-full max-w-screen-2xl mx-auto px-4 lg:px-8">
        <div className="relative w-full flex justify-center -mt-7  ">
          <div className="w-full md:w-9/12 lg:w-7/12 flex bg-white rounded  shadow-xl overflow-hidden">
            ...
            <input
              type="text"
              className="flex-grow py-4 px-2 text-sm lg-text-xl text-black outline-none font-amifer"
              placeholder="Search destinations..."
            />
            <button className="px-4 lg:px-6  text-sm lg:text-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-transform transform hover:scale-105">
              Search
            </button>
          </div>
        </div>
        ...
        {/* Image Slider */}
<div className="mt-12 w-full max-w-screen-lg mx-auto sm:max-w-md md:max-w-lg lg:max-w-7xl xl:max-w-7xl">
  <ImageSlider />
</div>


        {/* Top Rated Itineraries Section */}
        <div className="lg:mt-10 mt-4 lg:mx-24 ">
        ...
        <div className="mt-6 lg:mx-24  lg:mt-10">
          <h2 className="text-l lg:text-xl ml-2 lg:ml-8   text-black font-bold text-left flex items-center">
      ...
      <div className="w-full bg-gradient-to-b from-blue-500 to-white py-6  lg:py-10 mt-10 lg:mt-8 shadow-lg">
        <h2 className="text-xl lg:text-3xl font-bold text-center mb-6 lg:mb-8 text-white">
          Explore More
        </h2>
      ...
      <div className="w-full relative">
        ...
        <footer className="w-full bg-gradient-to-r from-white to-blue-200 text-blue-800  lg:py-4 lg:px-8 shadow-2xl">
          <div className="max-w-screen-2xl mx-auto px-6">
            <div className="flex pt-4 lg:pt-0 flex-row justify-between">
              <div className="mb-6 ">
